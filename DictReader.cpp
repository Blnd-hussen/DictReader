...
std::vector<std::string> DictReader::split(const std::string str, const char delimiter)
{
...
std::vector<std::string> DictReader::getFieldNames()
{
  return fieldNames;
}
...
size_t DictReader::getNumbLines()
{
  return numbLines;
}
